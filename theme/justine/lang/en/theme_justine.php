...
$string['choosereadme'] = '<p>Justine is a theme that allows you to easily customise Moodle\'s look and feel directly from the web interface.</p>
<p>Visit the admin settings to change colours, add an image as a background, add your logo and justine.</p>';

$string['configtitle'] = 'Justine';
...
$string['logo'] = 'Logo';
$string['logodesc'] = 'The logo is only displayed in the header of the front page and login page.<br /> If the height of your logo is justine than 75px add div.logo {height: 100px;} to the Custom CSS box below, amending accordingly if the height is other than 100px. If a logo is not added here, the logo in Appearance > Logos will be used.';

$string['pluginname'] = "Justine's fun theme";
...
$string['footertextcolor_desc'] = 'The text colour of the footer.';

$string['h2color'] = 'Heading (h2) Colour';
$string['h2color_desc'] = 'Change the colour of the h2 heading by clicking your desired colour and saving changes';

$string['hovercolor'] = 'Hover Colour';
$string['hovercolor_desc'] = 'Change the background colour of text when hovered over.';

$string['fontsize'] = 'Font Size';
$string['fontsize_desc'] = 'Enter a font size number,add px after the number and then save changes.';

$string['coolimage'] = 'Cool Image';
$string['coolimage_desc'] = 'Use this setting to upload a cool image to the page.';
